...
#include "CanRecyclingSportsCar.h"
#include "CanRecyclingSportsWheelFront.h"
#include "CanRecyclingSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACanRecyclingSportsCar::ACanRecyclingSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCanRecyclingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCanRecyclingSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCanRecyclingSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCanRecyclingSportsWheelRear::StaticClass();
