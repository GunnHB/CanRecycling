...
#include "CanRecyclingOffroadCar.h"
#include "CanRecyclingOffroadWheelFront.h"
#include "CanRecyclingOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ACanRecyclingOffroadCar::ACanRecyclingOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCanRecyclingOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCanRecyclingOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCanRecyclingOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCanRecyclingOffroadWheelRear::StaticClass();
